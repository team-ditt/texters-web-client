...
export default function UnpublishBookDialog({
  isUnpublishing,
  onConfirm = () => {},
  onRequestClose,
  ...props
  ...
  return (
    <ReactModal
      ...
      <div className="px-5 py-2 overflow-y-auto flex flex-col gap-1 border-b border-[#242424]">
        <h1 className="font-bold text-[22px]">작품 비공개</h1>
      </div>

      <div className="px-5 py-2">
        <span className="text-[18px] font-bold">작품을 비공개할까요?</span>

        <ul className="ps-4 py-1">
          <li className="list-disc list-outside">언제든지 다시 공개할 수 있으니 걱정마세요!</li>
          <li className="list-disc list-outside">
            하지만 조심하세요, 벌써 새로운 내용을 써 놓으셨다면 다시 공개할 때에는 그것도 함께
            공개될 거예요...
          </li>
          <li className="list-disc list-outside">
            비공개하더라도 달린 댓글, 좋아요는 그대로 남아 있을 거예요!
          </li>
        </ul>
      </div>
